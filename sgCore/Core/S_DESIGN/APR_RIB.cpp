...
static  OSCAN_COD  apr_line3      (lpOBJ obj,lpSCAN_CONTROL lpsc);
static  OSCAN_COD  apr_circle3    (lpOBJ obj,lpSCAN_CONTROL lpsc);
static  OSCAN_COD  apr_arc3       (lpOBJ obj,lpSCAN_CONTROL lpsc);
static  OSCAN_COD  apr_spline3    (lpOBJ obj,lpSCAN_CONTROL lpsc);

static OSCAN_COD  (**apr_typeg2)(lpOBJ obj,lpSCAN_CONTROL lpsc);
...
BOOL apr_rib( hOBJ hobj, short work_type ){
	...
	apr_typeg2 = (OSCAN_COD(**)(lpOBJ obj,lpSCAN_CONTROL lpsc))GetMethodArray(OMT_APR_RIB);

	apr_typeg2[OLINE]  = apr_line3;		// OLINE
	apr_typeg2[OCIRCLE]= apr_circle3;	// OCIRCLE
	apr_typeg2[OARC]   = apr_arc3;			// OARC
	apr_typeg2[OSPLINE]= apr_spline3;	// OSPLINE
...
static  OSCAN_COD apr_rib_scan(hOBJ hobj,lpSCAN_CONTROL lpsc){
	...
	obj = (lpOBJ)hobj;
	cod = apr_typeg2[lpsc->type](obj,lpsc);
