...
static  OSCAN_COD  apr_line2      (lpOBJ obj,lpSCAN_CONTROL lpsc);
static  OSCAN_COD  apr_circle2    (lpOBJ obj,lpSCAN_CONTROL lpsc);
static  OSCAN_COD  apr_arc2       (lpOBJ obj,lpSCAN_CONTROL lpsc);
static  OSCAN_COD  apr_spline2    (lpOBJ obj,lpSCAN_CONTROL lpsc);

static BOOL first;
static OSCAN_COD  (**apr_typeg1)(lpOBJ obj,lpSCAN_CONTROL lpsc);
...
BOOL apr_path(lpVDIM vdim, hOBJ hobj)
{
	...
	apr_typeg1 = (OSCAN_COD(**)(lpOBJ obj,lpSCAN_CONTROL lpsc))GetMethodArray(OMT_APR_PATH);

	apr_typeg1[OLINE]  = apr_line2;		// OLINE
	apr_typeg1[OCIRCLE]= apr_circle2;	// OCIRCLE
	apr_typeg1[OARC]   = apr_arc2;		// OARC
	apr_typeg1[OSPLINE]= apr_spline2;	// OSPLINE
...
static  OSCAN_COD apr_geo_scan(hOBJ hobj,lpSCAN_CONTROL lpsc)
{
	...
	obj = (lpOBJ)hobj;
	cod = apr_typeg1[lpsc->type](obj,lpsc);
...
static  OSCAN_COD apr_spline2(lpOBJ obj, lpSCAN_CONTROL lpsc)
{
	...
	if (obj->extendedClass==NULL || 
		...
		(reinterpret_cast<sgCSpline*>(obj->extendedClass)->GetGeometry()->GetPointsCount()==0) ||
