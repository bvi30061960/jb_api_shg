...
public:
  ...
  bool    TriangulateOneNP(NP_STR_LIST* list_str, NPW* cur_np, bool needSmoothNormals);
#else
...
public:
    ...
    sgFloat*                GetGeneralBuffer() const {return m_general_buffer;};
    unsigned int*           GetIndexesBuffer() const {return m_indexes;};
