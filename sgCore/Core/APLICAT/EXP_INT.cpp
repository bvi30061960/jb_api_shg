...
static int sort_function11( const short *a, const short *b);
...
//			fe = np->c[out_loop].fe;
	...
	qsort((void*)loops,il,sizeof(LOOP_DATA),(fptr)sort_function11);
...
int sort_function11( const short *a, const short *b)
{
