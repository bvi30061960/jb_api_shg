...
static void  o_modify_limits_by_point22(lpD_POINT p, lpREGION_3D reg)
{
...
OSCAN_COD get_point_limits(void * geo, lpSCAN_CONTROL lpsc)
{
  ...
  if ( lpsc->m ) o_hcncrd(lpsc->m,(lpD_POINT)geo,&p);
	...
	o_modify_limits_by_point22(&p,(lpREGION_3D)lpsc->lparam);
	return OSTRUE;
}
...
OSCAN_COD get_line_limits(void * geo, lpSCAN_CONTROL lpsc)
{
	...
	o_modify_limits_by_point22(&p1,(lpREGION_3D)lpsc->lparam);
	o_modify_limits_by_point22(&p2,(lpREGION_3D)lpsc->lparam);
	return OSTRUE;
}
...
lpSCAN_CONTROL lpsc = (lpSCAN_CONTROL)user_data;
	...
	o_modify_limits_by_point22(pb, (lpREGION_3D)lpsc->lparam);
	o_modify_limits_by_point22(pe, (lpREGION_3D)lpsc->lparam);
	return TRUE;
}
