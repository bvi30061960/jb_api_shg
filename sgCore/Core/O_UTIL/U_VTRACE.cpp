...
{
#if (SG_CURRENT_PLATFORM==SG_PLATFORM_MAC || SG_CURRENT_PLATFORM==SG_PLATFORM_IOS)
  ...
  long i;
    ...
    )
	{
			if (show_memory_leaks)
			{
					...
					#if (SG_CURRENT_PLATFORM==SG_PLATFORM_WINDOWS)
						#ifdef  NEED_MEMORY_REPORT
					  		MessageBoxA(NULL, buf, "MEMORY LEAK",MB_OK|MB_ICONERROR) ;
						#endif
					#endif
                        
                    #if (SG_CURRENT_PLATFORM==SG_PLATFORM_IOS  || SG_CURRENT_PLATFORM==SG_PLATFORM_ANDROID || SG_CURRENT_PLATFORM==SG_PLATFORM_MAC  || SG_CURRENT_PLATFORM==SG_PLATFORM_LINUX)
