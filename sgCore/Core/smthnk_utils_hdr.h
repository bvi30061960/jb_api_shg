...
typedef enum {W_BACKFACE, W_BPOINT, W_SET_AND_REGEN, W_NUM2} TMPTPDF1;
typedef enum {W_CONSTR, W_SKETCH, W_COND, W_APPROCH, W_DUMMY, W_FULL, W_NUM} TMPTPDF2;
