...
{
	POINT_PAIR*  b_e_P = (POINT_PAIR*)SGMalloc(sizeof(POINT_PAIR)*cnt);
	...
	GRAPH_VERTEX*  gr_Pnts = (GRAPH_VERTEX*)SGMalloc(sizeof(GRAPH_VERTEX)*2*cnt);
	...
	sgCObject** tmpArray = (sgCObject**)SGMalloc(sizeof(sgCObject*)*cnt);
	//memset(tmpArray,0,sizeof(sgCObject*)*cnt);
