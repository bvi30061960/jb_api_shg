...
sgCGroup*  sgCGroup::CreateGroup(sgCObject** objcts, int cnt)
{
	...
	char* typeID = (char*)"{0000000000000-0000-0000-000000000010}";
...
sgCContour*  sgCContour::CreateContour(sgCObject** objcts, int cnt)
{
	...
	set_contacts_on_path(hpath);//assert(0);  // for ANDROID
	...
	char* typeID = (char*)"{0000000000000-0000-0000-000000000007}";
