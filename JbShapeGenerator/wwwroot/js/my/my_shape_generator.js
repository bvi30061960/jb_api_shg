    ...
    if (typeof this.create_shape_generator != "function") {
        ...
        Shape_generator.prototype.refreshModel = async function () {
            ...
            try {
                ...
                this.progress_bar = new ProgressBar(this, "https://localhost:7095/CalcJBModel", Constants.method_refresh_premodel /*Constants.method_read_progress_value*/, this.client_id);
        ...
        //22112024 
        //-------------------------------------------------------------------
        async function read_result_refresh_model(pv_url) {
            ...
            try {
                ...
                get_read_result_refresh_model(lv_url);


                //--------------------------------------------------
                async function get_read_result_refresh_model(pv_url) {
                    //--------------------------------------------------
                    await $.get(pv_url, "", lo_active_side.oncomplete_read_result_refresh_model);
                }
...
Shape_generator.prototype.oncomplete_read_result_refresh_model = function (po_data) {
