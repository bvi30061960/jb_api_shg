...
export function Shape_generator(pv_active_id_prefix, pv_passive_id_prefix) {
    ...
    this.prev_width_mod = $(lv_id_side_shape_mod).width();//25082024
    this.prev_height_mod = $(lv_id_side_shape_mod).height();//25082024
    ...
    this.refreshModelInterval = 2000; // 2 sec
    ...
    if (typeof this.create_shape_generator != "function") {
        ...
        Shape_generator.prototype.oncomplete_read_model_part = function (po_data) {
            ...
            try {
                ...
                //=========================================================================
                //16102024 if (lo_active_side.model_curr_numpart == lo_active_side.model_numparts)
                if (lo_active_side.num_loaded_model_parts == lo_active_side.model_numparts) //16102024
                // конец загрузки
                {
        ...
        Shape_generator.prototype.adjust_splines_by_shape_in_side = function (po_side, pv_value) {
            ...
            if (po_side.params.is_space_adjust) {
                po_side.shapes.adjust_splines_by_external_shape();
            }
