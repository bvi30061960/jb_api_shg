namespace JbShapeGenerator.AppData
{
    ...
    public class PersistentDictionary<T>
    {
        ...
        private System.Collections.Generic.Dictionary<string, T>? ao_dictionary; 
        ...
        //------------------------------------------------------------------
        public System.Collections.Generic.Dictionary<string, T> ReadDictionary()
        {
            try
            {
                using (StreamReader lo_sr = new StreamReader(av_pathfile))
                {
                    ...
                    {
                        ao_dictionary = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.Generic.Dictionary<string, T>>(lv_stringValue);
                    }
                }
