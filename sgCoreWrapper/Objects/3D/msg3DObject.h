...
namespace sgCoreWrapper
{
	namespace Objects
	{
		...
		public:
			...
			{
				sgC3DObject::AutoTriangulate(isTriang, (SG_TRIANGULATION_TYPE)triangulationType, SG_SEPARATE_BUFFERS);
			}

			bool Triangulate(msgTriangulationTypeEnum triangulationType)
			{
				return sg3DObject->Triangulate((SG_TRIANGULATION_TYPE)triangulationType, SG_SEPARATE_BUFFERS);
			}
